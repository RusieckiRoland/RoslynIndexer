...
using RoslynIndexer.Net9.Adapters;     // MsBuildWorkspaceLoader, GitProbe
...
internal class Program
{
    static void Main(string[] args)
    {
        try
        {
            ConsoleLog.Info("=== RoslynIndexer.Net9 bootstrap ===");
    ...
    private static async Task MainAsync(string[] args)
    {
        ...
        // Log inputs (same style as Net48)
        ...
        //     (with ScriptDomSqlModelExtractor_waiting)
        // ===============================
        ...
        var result = await pipeline.RunAsync(paths, loader, CancellationToken.None);
        var files = result.files;
        var csharp = result.csharp;
